...
const pageTitles = {
  '/dashboard':   ['Overview', 'Monitor and manage all restaurants, hotels, users and system performance.'],
  ...
  '/bookings':    ['Bookings', 'Track all hotel room bookings.'],
  '/reviews':     ['Reviews', 'Moderate and manage venue reviews.'],
  '/finance':     ['Finance', 'Track and manage all financial transactions.'],
  '/reports':     ['Reports', 'View detailed system analytics reports.'],
...
export default function Layout() {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden', background: '#f5f5f5' }}>
      ...
      {/* ── Sidebar ── */}
      <aside style={{
        width: open ? 210 : 0, minWidth: open ? 210 : 0,
        background: '#1a1a2e',
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', minWidth: 0 }}>
        ...
        <header style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
            <button
              onClick={() => setOpen(v => !v)}
              style={{ background: 'transparent', border: 'none', color: '#718096', padding: 4, cursor: 'pointer', display: 'flex' }}
            >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div style={{
              ...
              <input
                ...
                style={{
                  ...
                  color: '#1a1a2e', fontSize: 13, width: 160,
                }}
              />
            </div>
            ...
            {/* Notification bell */}
            <button style={{
              position: 'relative', background: '#f7fafc',
              border: '1px solid #e2e8f0', borderRadius: 8,
              padding: '7px 8px', color: '#718096', cursor: 'pointer',
              display: 'flex', alignItems: 'center',
            }}>
